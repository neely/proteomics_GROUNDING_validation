...
if __name__ == "__main__":
    # Example PSM data (already filtered to 1% PSM FDR)
    example_psms = [
        {'peptide': 'PEPTIDE1', 'proteins': ['PROTA'], 'score': 10.5},
        {'peptide': 'PEPTIDE2', 'proteins': ['PROTA'], 'score': 9.8},
        {'peptide': 'PEPTIDE3', 'proteins': ['PROTB'], 'score': 11.2},
        {'peptide': 'PEPTIDE4', 'proteins': ['PROTA', 'PROTB'], 'score': 8.7},  # Shared peptide
        {'peptide': 'PEPTIDE5', 'proteins': ['PROTC'], 'score': 12.1},
    ]
    ...
    for protein in results:
        ...
        print(f"  Reported protein-level FDR: {protein['protein_level_fdr']}")
        print()